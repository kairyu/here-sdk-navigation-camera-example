...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioGroup cameraTrackingRadioGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraTrackingRadioGroup = findViewById(R.id.camera_tracking_radio_group);
        ...
        mapView.getMapScene().loadScene(MapScheme.NORMAL_DAY, new MapScene.LoadSceneCallback() {
            ...
            public void onLoadScene(@Nullable MapError mapError) {
                if (mapError == null) {
                    ...
                    app = new App(MainActivity.this, mapView, messageView, cameraTrackingRadioGroup);
    ...
    public void dynamicCameraTrackingButtonClicked(View view) {
        if (app != null) {
            app.dynamicCameraTrackingButtonClicked();
        }
    }

    public void fixedCameraTrackingButtonClicked(View view) {
        if (app != null) {
            app.fixedCameraTrackingButtonClicked();
        }
    }

    public void noCameraTrackingButtonClicked(View view) {
        if (app != null) {
            app.noCameraTrackingButtonClicked();
        }
    }
