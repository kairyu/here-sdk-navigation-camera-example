...
public class App {
    ...
    private final RadioGroup cameraTrackingRadioGroup;

    public App(Context context, MapView mapView, TextView messageView, RadioGroup cameraTrackingRadioGroup) {
        this.context = context;
        this.mapView = mapView;
        this.messageView = messageView;
        this.cameraTrackingRadioGroup = cameraTrackingRadioGroup;
        ...
        switch (cameraTrackingRadioGroup.getCheckedRadioButtonId()) {
            case R.id.dynamic_camera_tracking_button:
                cameraTrackingMode = CameraTrackingMode.DYNAMIC;
                break;
            case R.id.fixed_camera_tracking_button:
                cameraTrackingMode = CameraTrackingMode.FIXED;
                break;
            case R.id.no_camera_tacking_button:
                cameraTrackingMode = CameraTrackingMode.DISABLED;
                break;
            default:
                throw new RuntimeException("Unknown camera tracking mode.");
        }
        navigationExample = new NavigationExample(context, mapView, messageView, cameraTrackingMode);
    ...
    public void dynamicCameraTrackingButtonClicked() {
        navigationExample.setCameraTrackingMode(CameraTrackingMode.DYNAMIC);
    }

    public void fixedCameraTrackingButtonClicked() {
        navigationExample.setCameraTrackingMode(CameraTrackingMode.FIXED);
    }

    public void noCameraTrackingButtonClicked() {
        navigationExample.setCameraTrackingMode(CameraTrackingMode.DISABLED);
    }
    ...
    private void setPanGestureHandler() {
        mapView.getGestures().setPanListener((gestureState, origin, translation, velocity) -> {
            navigationExample.setCameraTrackingMode(CameraTrackingMode.DISABLED);
            if (cameraTrackingRadioGroup.getCheckedRadioButtonId() != R.id.no_camera_tacking_button) {
                cameraTrackingRadioGroup.check(R.id.no_camera_tacking_button);
            }
        });
    }
